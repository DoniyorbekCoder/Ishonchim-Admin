<script setup lang="ts">
    ...
    const TableTitle = defineAsyncComponent(() => import('@/components/passport/TableTitle.vue'));
    const TableItem = defineAsyncComponent(() => import('@/components/passport/TableItem.vue'));
