...
<template>
   <router-link :to="{path: '/user', query:{id: JSON.stringify(props.id)}}" role="button" class="flex w-full items-center justify-between px-15 leading-21 text-sm text-black-primary font-medium gap-15 mb-15">
